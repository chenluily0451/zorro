import { Component, ContentChild, ViewEncapsulation, ContentChildren } from '@angular/core';
import { NzTimelineItemComponent } from './nz-timeline-item.component';
var NzTimelineComponent = (function () {
    ...
    NzTimelineComponent.prototype.ngAfterContentInit = function () {
        if (this._listOfTimeline && this._listOfTimeline.length) {
            var listArray = this._listOfTimeline.toArray();
