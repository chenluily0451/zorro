import { Component, ViewEncapsulation, Input, ElementRef, Renderer2, HostListener, HostBinding, Output, EventEmitter } from '@angular/core';
import { TagAnimation } from '../core/animation/tag-animations';
var NzCheckableTagComponent = (function () {
    ...
    Object.defineProperty(NzCheckableTagComponent.prototype, "_backgroundColor", {
        get: function () {
            var isPresetColor = this._isPresetColor(this.nzColor);
            return (this.nzColor && !isPresetColor) ? this.nzColor : null;
        },
        enumerable: true,
        configurable: true
    });
    NzCheckableTagComponent.prototype._afterClose = function (event) {
        if (this._closed) {
    ...
    NzCheckableTagComponent.prototype._handleClick = function (event) {
        event.preventDefault();
        this.nzChange.emit(!this.nzChecked);
    };
    NzCheckableTagComponent.prototype._close = function (event) {
    ...
    NzCheckableTagComponent.prototype._isPresetColor = function (color) {
        return /^(pink|red|yellow|orange|cyan|green|blue|purple)(-inverse)?$/.test(color);
    };
    NzCheckableTagComponent.prototype.ngOnInit = function () {
    };
    NzCheckableTagComponent.prototype.ngAfterViewInit = function () {
        this._render.addClass(this._elementRef.nativeElement, this._prefixCls + "-root");
    };
    return NzCheckableTagComponent;
}());
export { NzCheckableTagComponent };
...
/** @nocollapse */
NzCheckableTagComponent.ctorParameters = function () { return [
    { type: ElementRef, },
    { type: Renderer2, },
]; };
