import { Component, HostBinding, ViewEncapsulation, Renderer2, ElementRef, Input } from '@angular/core';
var NzInputDirectiveComponent = (function () {
...
export { NzInputDirectiveComponent };
...
/** @nocollapse */
NzInputDirectiveComponent.ctorParameters = function () { return [
    { type: ElementRef, },
    { type: Renderer2, },
]; };
NzInputDirectiveComponent.propDecorators = {
    'nzSize': [{ type: Input },],
    'true': [{ type: HostBinding, args: ["class.ant-input",] },],
