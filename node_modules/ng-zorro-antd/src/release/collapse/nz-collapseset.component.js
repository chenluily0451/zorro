...
var NzCollapsesetComponent = (function () {
    ...
    NzCollapsesetComponent.prototype.nzClick = function (collapse) {
        var _this = this;
        if (this.nzAccordion) {
    ...
    NzCollapsesetComponent.prototype.addTab = function (collapse) {
        this.panels.push(collapse);
    };
    return NzCollapsesetComponent;
}());
export { NzCollapsesetComponent };
...
/** @nocollapse */
NzCollapsesetComponent.ctorParameters = function () { return []; };
