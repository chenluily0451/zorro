import { Component, Input, ViewEncapsulation, ElementRef, Renderer2, ContentChild, ViewChild } from '@angular/core';
import { NzStepConnectService } from './nz-step-connect.service';
var NzStepComponent = (function () {
    function NzStepComponent(erf, nzStepConnectService, _renderer) {
        this.erf = erf;
    ...
    NzStepComponent.prototype.initClassMap = function () {
        this.stepStatusClass = (_a = {},
            ...
            _a['ant-steps-next-error'] = (this.nzStepConnectService.errorIndex === 'error' && this._current === this.index - 1),
            _a);
    ...
    NzStepComponent.prototype.init = function () {
        var _this = this;
        // 记录个数
        ...
        this._processDotEventSubscription = this.nzStepConnectService.processDotEvent.subscribe(function (data) {
            _this._processDot = data;
        });
        this._directionEventSubscription = this.nzStepConnectService.directionEvent.subscribe(function (data) {
            _this._direction = data;
        });
        this._currentEventSubscription = this.nzStepConnectService.currentEvent.subscribe(function (data) {
            _this._current = data;
        });
        this._errorIndexObjectSubscription = this.nzStepConnectService.errorIndexObject.subscribe(function (data) {
            if (_this._current === _this.index) {
                _this._status = data;
            }
        });
        this.initClassMap();
        ...
        if (!this.erf.nativeElement.nextElementSibling) {
            ...
            this.nzStepConnectService.lastElementSizeEvent.subscribe(function (data) {
                var count = data.count, width = data.width;
                _this._renderer.setStyle(_this.erf.nativeElement, 'width', (100 / (count - 1)) + '%');
                _this._renderer.setStyle(_this.erf.nativeElement, 'margin-right', (-(width / (count - 1) + 5)) + 'px');
                if (_this._direction === 'horizontal') {
                    _this._renderer.setStyle(_this._stepsTail.nativeElement, 'padding-right', ((width / (count - 1) + 5)) + 'px');
                }
            });
        }
    };
    NzStepComponent.prototype.ngOnInit = function () {
        this.init();
    };
