import { Component, ViewEncapsulation, Input, Renderer2, ContentChild, Output, EventEmitter } from '@angular/core';
...
var NzDropDownComponent = (function () {
    function NzDropDownComponent(_renderer) {
    ...
    Object.defineProperty(NzDropDownComponent.prototype, "nzPlacement", {
        ...
        set: function (value) {
            ...
            this._positions.unshift(POSITION_MAP[this._placement]);
        },
        enumerable: true,
        configurable: true
    });
    ;
    NzDropDownComponent.prototype._onClickEvent = function () {
        if (this.nzTrigger === 'click') {
            this._show();
        }
    };
    NzDropDownComponent.prototype._onMouseEnterEvent = function (e) {
        if (this.nzTrigger === 'hover') {
            this._show();
        }
    };
    NzDropDownComponent.prototype._onMouseLeaveEvent = function (e) {
        if (this.nzTrigger === 'hover') {
            this._hide();
        }
    };
    NzDropDownComponent.prototype._onPositionChange = function (position) {
        this._dropDownPosition = position.connectionPair.originY;
    };
    NzDropDownComponent.prototype._clickDropDown = function ($event) {
        $event.stopPropagation();
        if (this.nzClickHide) {
            this.nzVisible = false;
        }
    };
    NzDropDownComponent.prototype._setTriggerWidth = function () {
        this._triggerWidth = this._nzOrigin.elementRef.nativeElement.getBoundingClientRect().width;
    };
    NzDropDownComponent.prototype._show = function () {
        this._$mouseSubject.next(true);
    };
    NzDropDownComponent.prototype._hide = function () {
        this._$mouseSubject.next(false);
    };
    NzDropDownComponent.prototype.ngOnInit = function () {
        var _this = this;
        this._$mouseSubject.debounceTime(300).subscribe(function (data) {
            _this.nzVisible = data;
            if (_this.nzVisible) {
    ...
    NzDropDownComponent.prototype.ngAfterViewInit = function () {
        var _this = this;
        if (this.nzTrigger === 'hover') {
            this._renderer.listen(this._nzOrigin.elementRef.nativeElement, 'mouseenter', function () { return _this._show(); });
            this._renderer.listen(this._nzOrigin.elementRef.nativeElement, 'mouseleave', function () { return _this._hide(); });
        }
        if (this.nzTrigger === 'click') {
