import { Component, ViewEncapsulation, Input, ElementRef, forwardRef, ChangeDetectorRef, ViewChild, HostBinding } from '@angular/core';
...
var NzDatePickerComponent = (function () {
    function NzDatePickerComponent(_elementRef, _cdr) {
    ...
    NzDatePickerComponent.prototype._setTriggerWidth = function () {
    ...
    ;
    ;
    NzDatePickerComponent.prototype._changeTime = function ($event) {
        this._value = $event;
    };
    NzDatePickerComponent.prototype._blurInput = function (box) {
        if (Date.parse(box.value)) {
            this.nzValue = new Date(box.value);
            this.onChange(this._value);
        }
    };
    NzDatePickerComponent.prototype._preYear = function () {
        this._showYear = this._showYear - 1;
    };
    NzDatePickerComponent.prototype._nextYear = function () {
        this._showYear = this._showYear + 1;
    };
    NzDatePickerComponent.prototype._preMonth = function () {
    ...
    NzDatePickerComponent.prototype._nextMonth = function () {
    ...
    NzDatePickerComponent.prototype._setShowYear = function (year, $event) {
        $event.stopPropagation();
        this._showYear = year;
        this._mode = 'year';
    };
    NzDatePickerComponent.prototype._preDecade = function () {
        this._startDecade = this._startDecade - 10;
    };
    NzDatePickerComponent.prototype._nextDecade = function () {
        this._startDecade = this._startDecade + 10;
    };
    NzDatePickerComponent.prototype._clearValue = function (e) {
        e.preventDefault();
        e.stopPropagation();
        this.nzValue = null;
        this.onChange(this._value);
    };
    NzDatePickerComponent.prototype._changeToToday = function () {
        this.nzValue = new Date();
        this.onChange(this._value);
        this._closeCalendar();
    };
    NzDatePickerComponent.prototype._clickDay = function (day) {
        if (!this.nzShowTime) {
            this._closeCalendar();
    ...
    NzDatePickerComponent.prototype._clickMonth = function (month) {
        this._showMonth = month.index;
        this._mode = 'year';
    };
    NzDatePickerComponent.prototype._openCalendar = function () {
        if (this.nzDisabled) {
            return;
        }
        this._mode = 'year';
    ...
    NzDatePickerComponent.prototype._closeCalendar = function () {
        if (!this._open) {
            return;
        }
        if (this.nzShowTime) {
    ...
    NzDatePickerComponent.prototype._changeMonthView = function () {
        this._mode = 'month';
    };
    NzDatePickerComponent.prototype._changeDecadeView = function ($event) {
        $event.stopPropagation();
        this._mode = 'decade';
    };
    NzDatePickerComponent.prototype._changeTimeView = function ($event) {
        var _this = this;
        $event.stopPropagation();
        this._mode = 'time';
    ...
    NzDatePickerComponent.prototype._changeYearView = function ($event) {
        $event.stopPropagation();
        this._mode = 'year';
    };
    ...
    NzDatePickerComponent.prototype._generateYearPanel = function () {
        var _t = [];
        for (var i = 0; i < 10; i++) {
            if (i === 1 || i === 4 || i === 7 || i === 9) {
                _t.push(i);
...
NzDatePickerComponent.propDecorators = {
    ...
    'true': [{ type: HostBinding, args: ['class.ant-calendar-picker',] },],
};
